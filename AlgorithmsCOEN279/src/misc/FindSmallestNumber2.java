/*
 To find the smallest number in the array by divide and conquer method
 */
package misc;
...
public class FindSmallestNumber2 {
    ...
    public int smallestNumber(int[] array, int left, int right) throws Exception {
        ...
        if (left > right) {
            throw new Exception("Please check the parameters passed. Left is greater than right");
        }
        ...
        // If there are two elemnts the compare and return the smallest.
        if (numberOfElements == 2) {
            return array[0] > array[1] ? array[1] : array[0];
        }

        // Divide the array into logical halves if the element is in the array is more than 2
        ...
        // Merge
        //compare and result returned by the recursive call and return the smallest number.
